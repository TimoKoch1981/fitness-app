        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <textarea
              ...
              rows={10}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-800 focus:ring-2 focus:ring-theme-primary focus:border-theme-primary outline-none resize-none"
              autoFocus
            />
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700 flex gap-2">
            ...
            {parsedRecipe ? (
              <button
                ...
                className="flex-1 py-2.5 bg-theme-primary-2 text-white rounded-lg text-sm font-medium hover:bg-theme-primary-2"
              >
              ...
              <button
                onClick={handleParse}
                disabled={!text.trim()}
                className="flex-1 py-2.5 bg-theme-primary-2 text-white rounded-lg text-sm font-medium hover:bg-theme-primary-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
